...
public class MainActivityViewModelTest {
    ...
    public void test_nominal_case_no_filter() throws InterruptedException {
        ...
        // Given
        MutableLiveData<List<MeetingRoomItem>> meetingRoomItemListMutableLiveData = new MutableLiveData<>();
        ...
        MutableLiveData<List<MeetingTimeItem>> meetingTimeItemListMutableLiveData = new MutableLiveData<>();
